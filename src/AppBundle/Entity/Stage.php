...
class Stage
{
     ...
     * @Assert\GreaterThanOrEqual("today", message="Cette date doit être supérieur ou égale à la date du jour")
     */
    private $fromDate;
    ...
    /**
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Provider", inversedBy="stages", cascade={"persist"})
     *
